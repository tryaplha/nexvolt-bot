...
const initializeBot = async () => {
    console.clear();
    console.log(chalk.cyan(figlet.textSync('NEXVOLT MD ʙᴏᴛ ᴀᴄᴛɪᴠᴇ', {
        font: 'Standard',
    ...
    console.log(chalk.green('𝐀𝐗𝐈𝐎𝐌 𝐌𝐃'));
...
function launchBot() {
    console.clear();
    console.log(chalk.green('𝙰𝚇𝙸𝙾𝙼 𝙼𝙳  𝚂𝙾𝙻𝙾𝚂 𝙰𝙻𝙻ʟ....\n'));
    ...
    if (fs.existsSync(botPath)) {
        try {
            ...
            require('./bot');
            telegramLoaded = true;
            console.log(chalk.green('✅𝙰𝚇𝙸𝙾𝙼 𝙼𝙳 𝙸𝚂 𝙰𝙲𝚃𝙸𝚅𝙴'));
        } catch (error) {
    ...
    console.log(telegramLoaded ? chalk.green( '𝙰𝚇𝙸𝙾𝙼 𝙼𝙳:𝙰𝙲𝚃𝙸𝚅𝙴 ✅') : chalk.red('❌ 𝙰𝚇𝙸𝙾𝙼 𝙼𝙳'));
